...
namespace BaiTapLon.Controllers
{
    public class ProductController : Controller
    {
        ...
        public PartialViewResult Category()
        {
            ...
            var model = new CategoryDraw().ListAllCategory(5);
            ViewBag.Sanphamnew = new SanphamDraw().listSanphamnew(5);
            ViewBag.topHot = new SanphamDraw().listTopSellings(5);
            ViewBag.getAllProduct = new SanphamDraw().getAllProduct();
            ViewBag.getProduct = new SanphamDraw().getProduct(5);
        ...
        public ActionResult ListProduct(long? idCate,int page = 1, int pageSize = 20)
        {
            ...
            ViewBag.total = new SanphamDraw().ListCount();
            ViewBag.Category = new CategoryDraw().ListAll();
            ViewBag.byUpPrice = new SanphamDraw().listProductByPrice("asc");
            ViewBag.byDownPrice = new SanphamDraw().listProductByPrice("desc");
            return View(model);
        }
